...
enum CONFIG_PARAM {UNKNOWN_CONFIG_PARAM = -1, ANALYSIS_TYPE = 0,  ILP_SIZE, BLOCK_SIZE, PAGE_SIZE, ITYPES_SPEC_FILE, CONF_PAR_CNT};
const char* config_params_str[CONF_PAR_CNT] = {"analysis_type",   "ilp_size", "block_size", "page_size", "itypes_spec_file"};
...
void read_config(ofstream* log,  MODE* mode, UINT32* _ilp_win_size, UINT32* _block_size, UINT32* _page_size, char** _itypes_spec_file){
