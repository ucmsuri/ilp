...
mica: mica.h mica.o mica_init.o mica_utils.o mica_ilp.o 
	$(CXX) -g $(PIN_LDFLAGS) $(LINK_DEBUG) mica.o mica_init.o mica_utils.o mica_ilp.o -o mica_ilp.so $(PIN_LPATHS) $(PIN_LIBS) $(DBG)
